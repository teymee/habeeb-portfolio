...
export default function ProjectOverviewCard({
  ...
  return (
    <section className=" bg-black-600 border w-full border-white-100 [ lg:h-[110vh] h-fit  ]  flex flex-col items-center justify-center py-10 space-y-8 [ lg:rounded-4xl rounded-2xl  ]">
      <div className="flex flex-col justify-center items-center">
        <img src={app} alt="" className=" [ lg:w-[600px] lg:h-[490px] w-[70%] ] " />
