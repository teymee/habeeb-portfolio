...
export default function ProjectOverviewCard({
  ...
  return (
    <Link to={`/project-details/${id}`} className=" bg-black-600 border w-full border-white-100 min-h-[90vh]  flex flex-col items-center justify-center py-10 space-y-8 [ lg:rounded-4xl rounded-2xl  ]">
